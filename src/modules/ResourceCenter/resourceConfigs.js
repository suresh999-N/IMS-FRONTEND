...
export const RESOURCE_CONFIGS = {
  ...
  users: {
    ...
    fields: [
      ...
      { name: 'phoneNumber', label: 'Phone No', required: true, minLength: 10, maxLength: 15 },
      { name: 'password', label: 'Password', type: 'password', requiredOnCreate: true, minLength: 8, createOnly: true },
