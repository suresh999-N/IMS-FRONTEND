...
const AdminSystemSettings = lazyWithPreload(() => import('../modules/Administration/SystemSettings/SystemSettings'))
...
export default function AppRoutes({ data, actions }) {
  ...
  const systemSettingsElement = withRouteSuspense(<AdminSystemSettings />)
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<MainLayout />}>
          ...
          <Route path="/administration/system-settings" element={systemSettingsElement} />
          <Route path="/system-settings" element={systemSettingsElement} />
        </Route>
      </Route>
