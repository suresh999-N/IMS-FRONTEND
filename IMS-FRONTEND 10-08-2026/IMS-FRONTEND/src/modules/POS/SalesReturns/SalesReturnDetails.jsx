...
export default function SalesReturnDetails({ data = {}, actions = {} }) {
  ...
  const formatSalesReturnCode = (val) => {
    if (!val) return ''
  ...
  const displayCode = formatSalesReturnCode(returnDetails.returnNumber || returnDetails.return_number || retId)
      ...
      <section className="card details-header-card">
        <div className="details-header-top">
          <div>
            ...
            <h2 className="details-id-title">{displayCode}</h2>
          </div>
