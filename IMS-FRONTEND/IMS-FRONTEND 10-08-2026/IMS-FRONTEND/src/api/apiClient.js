...
export function getResponseList(response, key) {
  ...
  const commonKeys = ['warehouses', 'Warehouses', 'suppliers', 'Suppliers', 'products', 'Products', 'purchaseOrders', 'PurchaseOrders', 'monthlySales', 'MonthlySales', 'monthlyPurchases', 'MonthlyPurchases', 'sales', 'Sales', 'purchases', 'Purchases', 'data', 'Data']
