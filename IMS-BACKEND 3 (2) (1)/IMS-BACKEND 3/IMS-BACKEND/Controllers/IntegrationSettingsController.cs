...
namespace IMSBackend.Controllers
{
    ...
    public class IntegrationSettingsController : ControllerBase
    {
        ...
        private const string SectionKey = "integration_settings";
        ...
        public async Task<IActionResult> GetIntegrationSettings()
        {
            ...
            if (section == null)
                return NotFound("Integration Settings section not found.");

            return Ok(section);
        }

        [HttpPut]
        public async Task<IActionResult> UpdateIntegrationSettings([FromBody] List<UpdateSystemRuleDto> rules)
        {
        ...
        [HttpPost("reset")]
        public async Task<IActionResult> ResetIntegrationSettings()
        {
            var section = await _context.SystemSettingSections
                .Include(x => x.Rules)
