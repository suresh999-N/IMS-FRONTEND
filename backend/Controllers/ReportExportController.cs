...
namespace IMSBackend.Controllers
{
    ...
    public class ReportExportController : ControllerBase
    {
        ...
        private const string SectionKey = "report_export";
        ...
        [HttpGet]
        public async Task<IActionResult> GetReportExportRules()
        {
            ...
            if (section == null)
                return NotFound("Report & Export section not found.");

            return Ok(section);
        }

        // PUT: api/report-export
        [HttpPut]
        public async Task<IActionResult> UpdateReportExportRules([FromBody] List<UpdateSystemRuleDto> rules)
        {
            ...
            return Ok(new
            {
                Message = "Report & Export rules updated successfully."
            });
        }

        // POST: api/report-export/reset
        [HttpPost("reset")]
        public async Task<IActionResult> ResetReportExportRules()
        {
            var section = await _context.SystemSettingSections
                .Include(x => x.Rules)
            ...
            return Ok(new
            {
                Message = "Report & Export rules reset successfully."
            });
        }
    }
}