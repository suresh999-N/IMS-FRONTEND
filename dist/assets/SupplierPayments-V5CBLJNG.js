import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{h as t,t as n}from"./jsx-runtime-Md2kjDfB.js";import{c as r,i,s as a,t as o,u as s}from"./erp-Bdf2pxjJ.js";import{t as c}from"./calendar-days-BX12kxgl.js";import{n as l,t as u}from"./Payments-BURT2eOX.js";import{t as d}from"./pencil-EgVeGJB0.js";import{t as f}from"./printer-jNtDF2O3.js";import{t as p}from"./trash-2-Ykn9Tzs3.js";import{C as m,Fn as h,Mn as g,N as _,Nn as v,Pn as y,Q as b,V as ee,X as te,Y as ne,ar as re,et as x,g as ie,h as ae,it as S,j as C,jn as w,u as oe,w as T,z as E,zt as D}from"./index-CRni9oUG.js";import{t as se}from"./CurrencyInput-CNIwNKqq.js";import{t as ce}from"./InputField-Bil30yVO.js";import{t as O}from"./SearchableSelect-BcizxUuJ.js";import{t as le}from"./FormModal-kUpBmAl3.js";import{S as ue,c as de,i as k,y as fe}from"./businessApi-DviNc4a0.js";import{t as pe}from"./DatePicker-D7B89XVt.js";import{n as me,t as he}from"./jspdf.plugin.autotable-CfCYMpJz.js";var A=e(t(),1),j=n(),M=[{value:`Cash`,label:`Cash`},{value:`Bank Transfer`,label:`Bank Transfer`},{value:`UPI`,label:`UPI`},{value:`Card`,label:`Card`},{value:`Cheque`,label:`Cheque`}],ge=[{value:`all`,label:`All Payments`},{value:`success`,label:`Success`},{value:`pending`,label:`Pending`},{value:`failed`,label:`Failed`},{value:`cancelled`,label:`Cancelled`},{value:`reversed`,label:`Reversed`},{value:`month`,label:`This Month`},{value:`last30`,label:`Last 30 Days`},{value:`large`,label:`Large Payments`}],_e=5e4,ve=`StockPilot IMS`,ye=`IMS`,N={name:ve,address:``,email:``,phone:``,gstNumber:``},P=595.28,be=841.89,F=794,I=1123,xe=[`paymentNumber`,`paymentDate`,`partyName`,`poId`,`amount`,`paymentMethod`,`status`,`actions`],Se=[`paymentNumber`,`actions`],L=`v12`,Ce={customer:`ims.customerPayments.visibleColumns.${L}`,supplier:`ims.supplierPayments.visibleColumns.${L}`},we={paymentNumber:144,paymentDate:112,partyName:160,poId:80,amount:112,paymentMethod:132,referenceNumber:170,status:96,createdBy:130,notes:200,cancelledAt:140,cancellationReason:200,actions:64};function Te(e,t){if(e==null||e===``)return null;let n=Number(e);if(!Number.isInteger(n)||n<=0)throw Error(`${t} must be selected from live API records.`);return n}function R(e){return e.paymentNumber?e.paymentNumber:`PAY-${String(e.paymentDate||h()).replaceAll(`-`,``)}-${String(e.paymentId||e.id||0).padStart(3,`0`)}`}function z(e){return String(e?.paymentRowId||e?.id||e?.paymentId||R(e))}function Ee(e){let t=e?.paymentId||e?.id;if(t!=null&&String(t).trim())return`payment-${String(t).trim()}`;let n=R(e);return n&&!n.endsWith(`-000`)?`number-${n}`:[`payment`,e?.invoiceId||`no-invoice`,e?.paymentDate||`no-date`,e?.amount||0,e?.referenceNumber||`no-reference`,e?.partyName||`no-party`].map(e=>String(e).trim().toLowerCase().replace(/\s+/g,`-`)).join(`|`)}function De(e){return{...e,paymentRowId:Ee(e)}}function B(e){let t=String(e.status||``).trim().toLowerCase();return t===`cancelled`||t===`canceled`?`Cancelled`:t===`reversed`||t===`voided`?`Reversed`:t===`failed`?`Failed`:t===`completed`||t===`success`||t===`paid`||t===`reconciled`||t===`posted`||t===`received`?`Completed`:`Pending`}function V(e){let t=B({status:e});return t===`Completed`?{label:`Success`,type:`success`,icon:x}:t===`Cancelled`?{label:`Cancelled`,type:`cancelled`,icon:l}:t===`Reversed`?{label:`Reversed`,type:`draft`,icon:E}:t===`Failed`?{label:`Failed`,type:`failed`,icon:l}:{label:`Pending`,type:`pending`,icon:c}}function Oe({status:e}){let t=V(e);return(0,j.jsx)(o,{type:t.type,icon:t.icon,children:t.label})}function ke(e){let t=Number(e||0),n=Math.abs(t),r=t<0?`-`:``;return n>=1e7?`${r}â‚¹${(n/1e7).toFixed(1)} Cr`:n>=1e5?`${r}â‚¹${(n/1e5).toFixed(1)} L`:w(t)}function H(e){let t=String(e||``).trim().toLowerCase();return t===`draft`||t===`sent`||t===`unpaid`?`Unpaid`:t===`partially paid`||t===`partial`?`Partial`:t===`paid`?`Paid`:t===`overdue`?`Overdue`:t===`cancelled`||t===`canceled`?`Cancelled`:e?String(e).trim():`Unpaid`}function Ae(e){let t=H(e);return t===`Paid`?{label:`Paid`,type:`success`,icon:x}:t===`Partial`?{label:`Partial`,type:`received`,icon:b}:t===`Unpaid`?{label:`Unpaid`,type:`pending`,icon:c}:t===`Overdue`?{label:`Overdue`,type:`failed`,icon:C}:t===`Cancelled`?{label:`Cancelled`,type:`cancelled`,icon:l}:{label:t,type:`info`,icon:ne}}function je(e,t,n={}){if(!e||t===`all`)return!0;let r=new Date(`${e}T00:00:00`);if(Number.isNaN(r.getTime()))return!0;let i=new Date;if(i.setHours(0,0,0,0),t===`today`)return r.getTime()===i.getTime();if(t===`last7`||t===`last30`){let e=t===`last7`?7:30,n=new Date(i);return n.setDate(i.getDate()-e+1),r>=n&&r<=i}if(t===`month`)return e.startsWith(i.toISOString().slice(0,7));if(t===`custom`){let e=n.from?new Date(`${n.from}T00:00:00`):null,t=n.to?new Date(`${n.to}T23:59:59`):null;if(e&&r<e||t&&r>t)return!1}return!0}function U(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&apos;`)}function W(e){return String(e||`Receipt`).replace(/[\\/:*?"<>|]+/g,`-`).replace(/\s+/g,`-`).replace(/-+/g,`-`)}async function G(e){let t=String(e||``).trim();if(!t)return!1;if(typeof navigator<`u`&&navigator.clipboard?.writeText)return await navigator.clipboard.writeText(t),!0;if(typeof document>`u`)return!1;let n=document.createElement(`textarea`);n.value=t,n.setAttribute(`readonly`,``),n.style.position=`fixed`,n.style.top=`-1000px`,document.body.appendChild(n),n.select();try{return document.execCommand(`copy`)}finally{document.body.removeChild(n)}}function Me(){return new Date().toLocaleString(`en-IN`,{year:`numeric`,month:`short`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`})}function K(e){return new Intl.NumberFormat(`en-IN`,{style:`currency`,currency:`INR`,minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(e||0))}function Ne(e){if(!e)return`N/A`;let t=new Date(`${e}T00:00:00`);return Number.isNaN(t.getTime())?g(e)||`N/A`:t.toLocaleDateString(`en-GB`,{day:`2-digit`,month:`short`,year:`numeric`}).replaceAll(` `,`-`)}function Pe(){return[N.address,N.email?`Email: ${N.email}`:``,N.phone?`Phone: ${N.phone}`:``,N.gstNumber?`GST: ${N.gstNumber}`:``].filter(Boolean)}function q(e){let t=H(e);return t===`Paid`?`badge-green`:t===`Partial`?`badge-amber`:`badge-red`}function Fe(e){let t=B({status:e});return t===`Completed`?`badge-green`:t===`Pending`?`badge-amber`:`badge-red`}function Ie(e){let t=String(e||``).trim().toLowerCase();return[`received`,`completed`,`paid`,`reconciled`].includes(t)?`badge-green`:[`ordered`,`pending`,`partial`,`partially received`,`partially_received`].includes(t)?`badge-amber`:`badge-red`}function Le(e,t=44,n=2){let r=String(e||`-`).split(/\s+/).filter(Boolean).flatMap(e=>{if(e.length<=t)return[e];let n=[];for(let r=0;r<e.length;r+=t)n.push(e.slice(r,r+t));return n}),i=[],a=``;r.forEach(e=>{let n=a?`${a} ${e}`:e;if(n.length>t&&a){i.push(a),a=e;return}a=n}),a&&i.push(a);let o=i.slice(0,n);return i.length>n&&(o[n-1]=`${o[n-1].slice(0,Math.max(0,t-1)).trim()}...`),o.length>0?o:[`-`]}function Re(e,t,n,r={}){let{maxLength:i=44,maxLines:a=2,lineHeight:o=18,className:s=`value`,anchor:c=`start`}=r;return`
  ...
  `}function ze(e,t,n){if(!Array.isArray(e)||e.length===0)return;let r=new me({orientation:`landscape`,unit:`mm`,format:`a4`}),i=t?`Supplier Payments Executive Statement`:`Customer Payments Executive Statement`,a=t?`Supplier Name`:`Customer Name`,o=t?`PO Number`:`Invoice Number`,s=e.length,c=e.reduce((e,t)=>e+(Number(t.amount)||0),0),l=e.filter(e=>{let t=V(e.status).label;return t===`Success`||t===`Completed`}).length,u=e.filter(e=>V(e.status).label===`Pending`).length;r.setFillColor(15,23,42),r.roundedRect(12,12,273,22,3,3,`F`),r.setFillColor(255,255,255),r.roundedRect(16,15.5,15,15,3,3,`F`),r.setTextColor(15,23,42),r.setFont(`helvetica`,`bold`),r.setFontSize(10),r.text(`IMS`,23.5,25,{align:`center`}),r.setFontSize(13),r.setTextColor(255,255,255),r.text(`StockPilot IMS`,35,22.5),r.setFontSize(8.5),r.setFont(`helvetica`,`normal`),r.setTextColor(148,163,184),r.text(i,35,28),r.setFontSize(8),r.setFont(`helvetica`,`bold`),r.setTextColor(t?45:96,t?212:165,t?191:250),r.text(`OFFICIAL FINANCIAL RECORD`,279,21.5,{align:`right`}),r.setTextColor(255,255,255),r.setFontSize(8),r.setFont(`helvetica`,`normal`),r.text(`Generated: ${Me()}`,279,28,{align:`right`}),[{label:`TOTAL RECORDS`,val:`${s} Payments`,color:[15,23,42]},{label:`TOTAL SETTLED AMOUNT`,val:K(c),color:[16,185,129]},{label:`COMPLETED / SUCCESS`,val:`${l}`,color:[22,163,74]},{label:`PENDING RECONCILIATION`,val:`${u}`,color:[217,119,6]}].forEach((e,t)=>{let n=12+t*69.25;r.setFillColor(248,250,252),r.setDrawColor(226,232,240),r.roundedRect(n,38,65.25,14,2,2,`FD`),r.setFontSize(7),r.setFont(`helvetica`,`bold`),r.setTextColor(100,116,139),r.text(e.label,n+4,43),r.setFontSize(9.5),r.setFont(`helvetica`,`bold`),r.setTextColor(e.color[0],e.color[1],e.color[2]),r.text(e.val,n+4,49)}),he(r,{startY:56,margin:{left:12,right:12,bottom:16},head:[[`Payment No`,`Date`,a,o,`Amount (INR)`,`Payment Method`,`Reference / UTR`,`Status`]],body:e.map(e=>[R(e),Ne(e.paymentDate),e.partyName||(t?`Supplier`:`Customer`),t?e.poNumber||(e.poId?`PO-${String(e.poId).padStart(3,`0`)}`:`-`):e.invoiceNumber||(e.invoiceId?`INV-${String(e.invoiceId).padStart(3,`0`)}`:`-`),K(e.amount),e.paymentMethod||`Bank Transfer`,e.referenceNumber||`N/A`,V(e.status).label]),theme:`grid`,headStyles:{fillColor:[15,23,42],textColor:[255,255,255],fontStyle:`bold`,fontSize:8.5,halign:`left`,cellPadding:2.5},bodyStyles:{fontSize:8,textColor:[30,41,59],cellPadding:2.5,overflow:`linebreak`},columnStyles:{0:{fontStyle:`bold`,cellWidth:36},1:{cellWidth:26},2:{cellWidth:54},3:{cellWidth:34},4:{halign:`right`,fontStyle:`bold`,cellWidth:32},5:{cellWidth:30},6:{cellWidth:35},7:{halign:`center`,cellWidth:26}},alternateRowStyles:{fillColor:[248,250,252]},didDrawPage:e=>{let t=r.internal.getNumberOfPages();r.setFontSize(8),r.setFont(`helvetica`,`normal`),r.setTextColor(148,163,184),r.text(`Generated by StockPilot IMS  |  Page ${e.pageNumber} of ${t}`,297/2,204,{align:`center`})}});let d=new Date().toISOString().slice(0,10),f=t?`Supplier-Payments-Report`:`Customer-Payments-Report`;r.save(`${f}-${d}.pdf`)}function Be({payment:e,purchaseOrder:t,invoice:n,metrics:r,generatedBy:i,isSupplier:a=!0}){let o=V(e.status).label,s=a?Ye(t?.status||e.poStatus):Ae(e.invoiceStatus).label,c=R(e),l=a?Je(e,t):qe(e,n),u=Me(),d=Pe(),f=Ne(a?t?.orderDate||e.poDate||e.paymentDate:n?.invoiceDate||e.invoiceDate||e.paymentDate),p=Number(r.outstandingAfter||0),m=a?`SUPPLIER PAYMENT RECEIPT`:`CUSTOMER PAYMENT RECEIPT`,h=a?`Supplier`:`Customer`,g=a?`Purchase Order`:`Invoice Number`,_=e.partyName||(a?t?.supplierName||`Supplier`:`Customer`),v=a?`Purchase Order Total`:`Invoice Total Amount`,y=String(i||`System Administrator`).slice(0,34);return`
    <svg xmlns="http://www.w3.org/2000/svg" width="${F}" height="${I}" viewBox="0 0 ${F} ${I}">
      ...
      ${Re(_,70,292,{maxLength:20,maxLines:2,className:`card-val-large`})}
      ...
      <text class="cell-desc" x="72" y="434">${U(v)}</text>
      ...
      <text class="footer-meta" x="397" y="941" text-anchor="middle">Issued By: ${U(y)}</text>
      <text class="footer-meta" x="724" y="941" text-anchor="end">System: ${U(ye)}</text>
    </svg>
  `}function Ve(e){let[,t=``]=e.split(`,`);return atob(t)}function He(e){let t=Ve(e),n=`q\n${P} 0 0 ${be} 0 0 cm\n/Im1 Do\nQ\n`,r=[`<< /Type /Catalog /Pages 2 0 R >>`,`<< /Type /Pages /Kids [3 0 R] /Count 1 >>`,`<< /Type /Page /Parent 2 0 R /MediaBox [0 0 ${P} ${be}] /Resources << /XObject << /Im1 4 0 R >> >> /Contents 5 0 R >>`,`<< /Type /XObject /Subtype /Image /Width ${F} /Height ${I} /ColorSpace /DeviceRGB /BitsPerComponent 8 /Filter /DCTDecode /Length ${t.length} >>\nstream\n${t}\nendstream`,`<< /Length ${n.length} >>\nstream\n${n}endstream`],i=`%PDF-1.4
`,a=[0];r.forEach((e,t)=>{a.push(i.length),i+=`${t+1} 0 obj\n${e}\nendobj\n`});let o=i.length;i+=`xref\n0 ${r.length+1}\n0000000000 65535 f \n`,a.slice(1).forEach(e=>{i+=`${String(e).padStart(10,`0`)} 00000 n \n`}),i+=`trailer\n<< /Size ${r.length+1} /Root 1 0 R >>\nstartxref\n${o}\n%%EOF`;let s=new Uint8Array(i.length);for(let e=0;e<i.length;e+=1)s[e]=i.charCodeAt(e)&255;return new Blob([s],{type:`application/pdf`})}async function Ue(e){let t=new Image,n=new Blob([e],{type:`image/svg+xml;charset=utf-8`}),r=URL.createObjectURL(n);try{await new Promise((e,n)=>{t.onload=e,t.onerror=n,t.src=r});let e=document.createElement(`canvas`);e.width=F,e.height=I;let n=e.getContext(`2d`);return n.fillStyle=`#ffffff`,n.fillRect(0,0,e.width,e.height),n.drawImage(t,0,0,e.width,e.height),e.toDataURL(`image/jpeg`,.96)}finally{URL.revokeObjectURL(r)}}async function We({payment:e,purchaseOrder:t,allPayments:n,generatedBy:r}){if(typeof document>`u`||typeof Image>`u`)throw Error(`PDF generation is only available in the browser.`);let i=He(await Ue(Be({payment:e,purchaseOrder:t,metrics:Qe(e,t,n),generatedBy:r}))),a=URL.createObjectURL(i),o=document.createElement(`a`),s=W(R(e));o.href=a,o.download=`Supplier-Payment-Receipt-${s}.pdf`,o.click(),URL.revokeObjectURL(a)}function Ge(e){let t=String(e||``).trim();return!t||/unknown column|unknown table|sql|mysql|database|exception|stack|system\.|microsoft\./i.test(t)?`Unable to load payment data right now.`:t}function Ke(e){return String(e?.invoiceId||e?.id||``)}function qe(e,t){return e.invoiceNumber||t?.invoiceNumber||(e.invoiceId?`INV-${String(e.invoiceId).padStart(3,`0`)}`:`Not applied`)}function Je(e,t){return e.poNumber||t?.poNumber||(e.poId?`PO-${String(e.poId).padStart(3,`0`)}`:`Not applied`)}function Ye(e){return String(e||`Ordered`).trim().replace(/[_-]+/g,` `).replace(/\b\w/g,e=>e.toUpperCase())}function Xe(e,t){let n=Number(e.invoiceAmount||t?.totalAmount||0),r=Number(e.outstandingAfter||t?.balanceAmount||0),i=Number(e.outstandingBefore||r+Number(e.amount||0));return{invoiceTotal:n,alreadyPaid:Math.max(0,n-Number(t?.balanceAmount||0)),outstandingBefore:i,outstandingAfter:Math.max(0,r)}}function Ze(e){let t=e?.paymentId??e?.id,n=Number(t);if(Number.isFinite(n)&&n>0)return n;let r=String(R(e)).match(/(\d+)(?!.*\d)/);return r?Number(r[1]):0}function J(e){return[e?.createdAt||e?.paymentDate||``,e?.paymentDate||``,String(Ze(e)).padStart(12,`0`),R(e)].join(`|`)}function Y(e){let t=B(e);return t!==`Cancelled`&&t!==`Failed`&&t!==`Reversed`}function X(e,t){let n=String(t?.poId||``).trim(),r=String(e?.poId||``).trim();return!!(n&&r&&n===r)}function Qe(e,t,n=[]){let r=Number(e.poAmount||t?.totalAmount||0),i=J(e),a=z(e),o=n.filter(t=>z(t)!==a&&Y(t)&&X(t,e)&&J(t)<i).reduce((e,t)=>e+Number(t.amount||0),0),s=Number(e.amount||0);return{invoiceTotal:r,previousPayments:o,outstandingBefore:Math.max(0,r-o),outstandingAfter:Math.max(0,r-o-s)}}function Z(e,t=[]){return t.filter(t=>Y(t)&&X(t,e)).sort((e,t)=>J(e).localeCompare(J(t)))}function $e(e,t){return Number(e.outstandingAfter||0)<=0?`paid`:H(t)===`Overdue`?`overdue`:`partial`}function et(e,t){let n=Number(e.invoiceTotal||0);if(n<=0)return 0;let r=Math.min(n,Number(e.previousPayments||0)+Number(t.amount||0));return Math.round(r/n*100)}function tt(e){try{if(typeof window>`u`)return null;let t=window.localStorage.getItem(e),n=t?JSON.parse(t):null;return Array.isArray(n)?n.filter(Boolean):null}catch{return null}}function Q({label:e,value:t,wide:n=!1}){return(0,j.jsxs)(`div`,{className:`payment-detail-item ${n?`payment-detail-item--wide`:``}`.trim(),children:[(0,j.jsx)(`dt`,{children:e}),(0,j.jsx)(`dd`,{children:t||`-`})]})}function nt({payment:e,purchaseOrder:t,allPayments:n=[],onClose:r,onPrint:i,onDownloadReceipt:a,onOpenPurchaseOrder:s}){let[c,l]=(0,A.useState)(e),[d,p]=(0,A.useState)(``);(0,A.useEffect)(()=>{l(e)},[e]),(0,A.useEffect)(()=>{if(!d)return;let e=window.setTimeout(()=>{p(``)},1200);return()=>window.clearTimeout(e)},[d]);let h=B(c),_=Ye(t?.status||c.poStatus),v=Qe(c,t,n),y=Z(c,n),b=$e(v,``),ee=et(v,c),te=Number(v.invoiceTotal||0),re=Math.max(0,Math.min(te,te-Number(v.outstandingAfter||0))),x=y.reduce((e,t)=>e+Number(t.amount||0),0),ie=z(c),ae=Je(c,t),S=c.referenceNumber||``,C=[{label:`Purchase Order Total`,value:w(v.invoiceTotal)},{label:`Previous Payments`,value:w(v.previousPayments)},{label:`Current Payment`,value:w(c.amount),emphasis:!0},{label:`Remaining Balance`,value:w(v.outstandingAfter),strong:!0,tone:b}],oe=async(e,t)=>{try{await G(e)&&(p(t),m({type:`success`,title:`Receipt`,message:`Copied to clipboard`}))}catch{m({type:`error`,title:`Receipt`,message:`Unable to copy value.`})}};return(0,j.jsxs)(`div`,{className:`payment-drawer payment-drawer--landscape`,role:`dialog`,"aria-modal":`true`,"aria-labelledby":`payment-drawer-title`,children:[(0,j.jsx)(`button`,{type:`button`,className:`payment-drawer__backdrop`,"aria-label":`Close payment details`,onClick:r}),(0,j.jsxs)(`aside`,{className:`payment-drawer__panel`,children:[(0,j.jsxs)(`header`,{className:`payment-drawer__header`,children:[(0,j.jsxs)(`div`,{className:`payment-drawer__title-group`,children:[(0,j.jsx)(`p`,{className:`payment-drawer__eyebrow`,children:`Receipt`}),(0,j.jsx)(`h2`,{id:`payment-drawer-title`,children:R(c)}),(0,j.jsxs)(`div`,{className:`payment-drawer__header-meta`,children:[(0,j.jsx)(Oe,{status:h}),(0,j.jsx)(`span`,{children:g(c.paymentDate)})]})]}),(0,j.jsx)(`button`,{type:`button`,className:`button button-secondary payment-drawer__close`,onClick:r,"aria-label":`Close payment details`,children:(0,j.jsx)(T,{size:15})})]}),(0,j.jsxs)(`section`,{className:`payment-drawer__summary-card`,"aria-label":`Payment summary`,children:[(0,j.jsxs)(`div`,{className:`payment-drawer__summary-main`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsxs)(`h3`,{children:[(0,j.jsx)(`span`,{children:R(c)}),(0,j.jsx)(`button`,{type:`button`,className:`payment-copy-button ${d===`payment-number`?`is-copied`:``}`.trim(),onClick:()=>oe(R(c),`payment-number`),"aria-label":`Copy payment number`,title:d===`payment-number`?`Copied`:`Copy payment number`,children:(0,j.jsx)(u,{size:13})})]}),(0,j.jsxs)(`div`,{className:`payment-drawer__summary-meta`,children:[(0,j.jsx)(Oe,{status:h}),(0,j.jsx)(`span`,{children:g(c.paymentDate)})]})]}),(0,j.jsx)(`strong`,{children:w(c.amount)})]}),(0,j.jsxs)(`div`,{className:`payment-drawer__summary-customer`,children:[(0,j.jsx)(`span`,{children:`Supplier`}),(0,j.jsx)(`strong`,{children:c.partyName||t?.supplierName||t?.supplier||`Supplier`})]})]}),(0,j.jsxs)(`div`,{className:`payment-drawer__content`,children:[(0,j.jsxs)(`section`,{className:`payment-drawer__finance-card`,"aria-label":`Financial summary`,children:[(0,j.jsxs)(`div`,{className:`payment-drawer__section-header`,children:[(0,j.jsx)(`h3`,{children:`Financial Summary`}),(0,j.jsx)(o,{type:`info`,children:_})]}),(0,j.jsxs)(`div`,{className:`payment-drawer__progress`,children:[(0,j.jsx)(`div`,{className:`payment-drawer__progress-copy`,children:(0,j.jsx)(`span`,{children:`Payment Progress`})}),(0,j.jsx)(`div`,{className:`payment-drawer__progress-track payment-drawer__progress-track--${b}`,"aria-label":`Payment progress ${ee}%`,children:(0,j.jsx)(`span`,{style:{width:`${ee}%`}})}),(0,j.jsxs)(`div`,{className:`payment-drawer__progress-values`,children:[(0,j.jsxs)(`span`,{children:[`Paid `,(0,j.jsx)(`strong`,{children:w(re)})]}),(0,j.jsxs)(`span`,{children:[`Remaining `,(0,j.jsx)(`strong`,{children:w(v.outstandingAfter)})]})]})]}),(0,j.jsx)(`div`,{className:`payment-receipt__summary`,"aria-label":`Payment allocation summary`,children:C.map(e=>(0,j.jsxs)(`div`,{className:[`payment-receipt__summary-row`,e.emphasis?`payment-receipt__summary-row--emphasis`:``,e.strong?`payment-receipt__summary-row--strong`:``,e.tone?`payment-receipt__summary-row--${e.tone}`:``].filter(Boolean).join(` `),children:[(0,j.jsx)(`span`,{children:e.label}),(0,j.jsx)(`strong`,{children:e.value})]},e.label))})]}),(0,j.jsxs)(`section`,{className:`payment-drawer__section payment-drawer__section--compact`,children:[(0,j.jsxs)(`div`,{className:`payment-drawer__section-header`,children:[(0,j.jsx)(`h3`,{children:`Payment Information`}),(0,j.jsxs)(`span`,{className:`payment-drawer__invoice-actions`,children:[(0,j.jsx)(`button`,{type:`button`,className:`payment-drawer__invoice-link`,onClick:()=>s?.(c,t),children:ae}),(0,j.jsx)(`button`,{type:`button`,className:`payment-copy-button ${d===`po-number`?`is-copied`:``}`.trim(),onClick:()=>oe(ae,`po-number`),"aria-label":`Copy purchase order number`,title:d===`po-number`?`Copied`:`Copy purchase order number`,children:(0,j.jsx)(u,{size:13})})]})]}),(0,j.jsxs)(`dl`,{className:`payment-info-inline`,children:[(0,j.jsx)(Q,{label:`Method`,value:c.paymentMethod||`Not Provided`}),(0,j.jsx)(Q,{label:`Reference Number`,value:S?(0,j.jsxs)(`span`,{className:`payment-detail-copy-value`,children:[(0,j.jsx)(`span`,{children:S}),(0,j.jsx)(`button`,{type:`button`,className:`payment-copy-button ${d===`reference-number`?`is-copied`:``}`.trim(),onClick:()=>oe(S,`reference-number`),"aria-label":`Copy reference number`,title:d===`reference-number`?`Copied`:`Copy reference number`,children:(0,j.jsx)(u,{size:13})})]}):`Not Provided`}),(0,j.jsx)(Q,{label:`Notes`,value:c.notes||`No Notes Available`,wide:!0})]})]}),(0,j.jsxs)(`section`,{className:`payment-drawer__section payment-drawer__timeline-card`,children:[(0,j.jsxs)(`div`,{className:`payment-drawer__timeline-header`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`h3`,{children:`Payment History`}),(0,j.jsxs)(`span`,{children:[y.length,` Payment`,y.length===1?``:`s`,` Recorded`]})]}),(0,j.jsxs)(`strong`,{children:[`Total Paid: `,w(x)]})]}),y.length>0?(0,j.jsx)(`ol`,{className:`payment-drawer__timeline-list`,children:y.map(e=>{let t=z(e),n=t===ie;return(0,j.jsxs)(`li`,{className:n?`is-active`:``,children:[(0,j.jsx)(`span`,{"aria-hidden":`true`}),(0,j.jsxs)(`button`,{type:`button`,onClick:()=>l(e),"aria-current":n?`true`:void 0,children:[(0,j.jsx)(`strong`,{children:R(e)}),(0,j.jsx)(`span`,{className:`payment-drawer__timeline-amount`,children:w(e.amount)}),(0,j.jsx)(`time`,{children:g(e.paymentDate||e.createdAt)})]})]},t)})}):(0,j.jsx)(`div`,{className:`payment-drawer__empty-state`,children:`No Previous Payments`})]})]}),(0,j.jsxs)(`footer`,{className:`payment-drawer__footer`,children:[(0,j.jsxs)(`p`,{className:`payment-drawer__recorded-line`,children:[`Recorded on `,g(c.createdAt||c.paymentDate),` by `,c.createdBy||`System`]}),(0,j.jsxs)(`div`,{className:`payment-drawer__actions`,children:[(0,j.jsxs)(`button`,{type:`button`,className:`button button-secondary`,onClick:()=>a(c),children:[(0,j.jsx)(ne,{size:16}),`Download PDF`]}),(0,j.jsxs)(`button`,{type:`button`,className:`button button-primary`,onClick:()=>i([c]),children:[(0,j.jsx)(f,{size:16}),`Print Receipt`]})]})]})]})]})}function rt({payment:e,invoice:t,onSubmit:n,onClose:r,isSubmitting:i}){let[a,o]=(0,A.useState)({amount:String(e.amount||``),paymentMethod:e.paymentMethod||`Bank Transfer`,referenceNumber:e.referenceNumber||``,notes:e.notes||``}),[s,c]=(0,A.useState)({}),l=Xe(e,t).outstandingAfter+Number(e.amount||0),u={amount:v(a.amount,`Amount`,{allowZero:!1})||(Number(a.amount)>l?`Amount cannot exceed ${w(l)}.`:``),referenceNumber:a.referenceNumber.length>100?`Reference number must be 100 characters or fewer.`:``,notes:a.notes.length>500?`Notes must be 500 characters or fewer.`:``},d=Object.values(u).every(e=>!e);function f(e){let{name:t,value:n}=e.target;o(e=>({...e,[t]:n}))}function p(e){c(t=>({...t,[e.target.name]:!0}))}function m(t){t.preventDefault(),c({amount:!0,referenceNumber:!0,notes:!0}),!(!d||i)&&n(e,a)}return(0,j.jsx)(le,{title:`Edit Payment`,subtitle:`Update receipt values without changing the customer, invoice, or payment number.`,onClose:r,children:(0,j.jsxs)(`form`,{className:`payment-form payment-edit-form`,onSubmit:m,children:[(0,j.jsxs)(`div`,{className:`payment-form__readonly-grid`,children:[(0,j.jsx)(Q,{label:`Payment Number`,value:R(e)}),(0,j.jsx)(Q,{label:`Customer`,value:e.partyName}),(0,j.jsx)(Q,{label:`Invoice Number`,value:qe(e,t)})]}),(0,j.jsxs)(`div`,{className:`form-grid`,children:[(0,j.jsx)(se,{id:`payment-edit-amount`,name:`amount`,label:`Amount`,value:a.amount,onChange:f,onBlur:p,error:s.amount?u.amount:``}),(0,j.jsx)(O,{id:`payment-edit-method`,name:`paymentMethod`,label:`Payment method`,value:a.paymentMethod,onChange:f,options:M}),(0,j.jsx)(ce,{id:`payment-edit-reference`,name:`referenceNumber`,label:`Reference number`,value:a.referenceNumber,maxLength:100,onChange:f,onBlur:p,error:s.referenceNumber?u.referenceNumber:``}),(0,j.jsx)(ce,{id:`payment-edit-notes`,name:`notes`,label:`Notes`,textarea:!0,rows:4,maxLength:500,className:`field--full`,value:a.notes,onChange:f,onBlur:p,error:s.notes?u.notes:``})]}),(0,j.jsxs)(`div`,{className:`button-row payment-form__footer`,children:[(0,j.jsx)(`button`,{type:`submit`,className:`button button-primary`,disabled:!d||i,children:i?`Saving...`:`Save Changes`}),(0,j.jsx)(`button`,{type:`button`,className:`button button-cancel`,onClick:r,disabled:i,children:`Cancel`})]})]})})}function it({type:e,partyLabel:t,parties:n,invoices:r,purchaseOrders:i,existingPayments:a,onSubmit:o,onCancel:s,isSubmitting:c}){let l=e===`supplier`,[u,d]=(0,A.useState)({partyId:``,invoiceId:``,poId:``,amount:``,paymentDate:h(),paymentMethod:`Bank Transfer`,referenceNumber:``,notes:``}),[f,p]=(0,A.useState)({}),m=(0,A.useMemo)(()=>r.find(e=>Ke(e)===String(u.invoiceId)),[u.invoiceId,r]),g=Number(m?.totalAmount||0),_=Number(m?.paidAmount||0),b=Number(m?.balanceAmount||0),ee=Number(u.amount||0),te=Math.max(0,b-ee),ne=u.referenceNumber.trim().toLowerCase(),re=ne&&a.some(e=>e.referenceNumber.trim().toLowerCase()===ne),x={partyId:y(u.partyId,t),invoiceId:l?``:y(u.invoiceId,`Invoice`),poId:l?y(u.poId,`Purchase order`):``,amount:v(u.amount,`Amount`,{allowZero:!1})||(!l&&m&&Number(u.amount)>b?`Amount cannot exceed outstanding balance.`:``),paymentDate:y(u.paymentDate,`Payment date`),referenceNumber:u.referenceNumber.length>100?`Reference number must be 100 characters or fewer.`:re?`This reference number is already used.`:``,notes:u.notes.length>500?`Notes must be 500 characters or fewer.`:``},ie=Object.values(x).every(e=>!e),ae=(0,A.useMemo)(()=>i.filter(e=>{if(!u.partyId)return!0;let t=n.find(e=>String(e.value)===String(u.partyId))?.label||``,r=String(e.supplierId||e.vendorId||``),i=String(e.supplier||e.supplierName||``);return r&&String(u.partyId)?r===String(u.partyId):t&&i?i.toLowerCase()===t.toLowerCase():!0}).map(e=>{let t=Array.isArray(e.items)?e.items.reduce((e,t)=>{let n=Number(t.quantity||t.orderedQuantity||t.qty||0),r=Number(t.price||t.unitPrice||t.unitCost||t.cost||0);return e+Number(t.total||t.lineTotal||t.amount||n*r||0)},0):0,n=Number(e.totalAmount||e.grandTotal||e.amount||e.netAmount||e.totalPrice||e.totalCost||e.subTotal||e.poAmount||t||0),r=e.poId||e.id;return{value:r,label:`${e.poNumber||(r?`PO-${r}`:`PO`)} - ${e.supplier||e.supplierName||`Supplier`} - ${w(n)}`,orderAmount:n,supplierId:e.supplierId||e.vendorId||``}}),[u.partyId,i,n]),S=(0,A.useMemo)(()=>r.filter(e=>u.partyId?String(e.customerId)===String(u.partyId):!0).map(e=>({value:Number(e.invoiceId||e.id),label:`${e.invoiceNumber||`Invoice ${e.invoiceId||e.id}`} - ${e.customerName||e.customer||`Customer`} - ${w(e.balanceAmount)}`})).filter(e=>Number.isInteger(e.value)&&e.value>0),[u.partyId,r]);function C(e){let{name:t,value:n}=e.target;if(t===`poId`){let e=ae.find(e=>String(e.value)===String(n)),t=i.find(e=>String(e.poId||e.id)===String(n)),r=e?.orderAmount??(t?t.totalAmount??t.grandTotal??t.amount??t.netAmount??``:``),a=e?.supplierId||(t?t.supplierId??t.vendorId??``:``);d(e=>({...e,poId:n,amount:r!==``&&r!=null?String(r):e.amount,partyId:a?String(a):e.partyId}));return}if(t===`invoiceId`){let e=r.find(e=>Ke(e)===String(n)),t=e?e.balanceAmount??e.totalAmount??``:``;d(e=>({...e,invoiceId:n,amount:t===``?e.amount:String(t)}));return}d(e=>({...e,[t]:n}))}function oe(e){let{value:t}=e.target;d(e=>({...e,partyId:t,invoiceId:!l&&e.invoiceId&&!r.some(n=>String(n.customerId)===String(t)&&Ke(n)===String(e.invoiceId))?``:e.invoiceId}))}function T(e){p(t=>({...t,[e.target.name]:!0}))}function E(e){e.preventDefault(),p({partyId:!0,invoiceId:!0,poId:!0,amount:!0,paymentDate:!0,referenceNumber:!0,notes:!0}),!(!ie||c)&&o(u)}return(0,j.jsxs)(`form`,{className:`payment-form`,onSubmit:E,autoComplete:`off`,children:[(0,j.jsxs)(`div`,{className:`payment-form__section`,children:[(0,j.jsx)(`div`,{className:`payment-form__section-header`}),(0,j.jsxs)(`div`,{className:`form-grid`,children:[(0,j.jsx)(O,{id:`payment-party`,name:`partyId`,label:t,value:u.partyId,onChange:oe,onBlur:T,options:n,placeholder:`Select ${t.toLowerCase()}`,error:x.partyId,showError:f.partyId}),l?(0,j.jsx)(O,{id:`payment-po`,name:`poId`,label:`Purchase order`,value:u.poId,onChange:C,onBlur:T,options:ae,placeholder:`Select purchase order`,error:x.poId,showError:f.poId}):(0,j.jsxs)(`div`,{className:`payment-form__invoice-field`,children:[(0,j.jsx)(O,{id:`payment-invoice`,name:`invoiceId`,label:`Invoice`,value:u.invoiceId,onChange:C,onBlur:T,options:S,placeholder:`Select invoice`,searchPlaceholder:`Search invoices...`,error:x.invoiceId,showError:f.invoiceId}),m?(0,j.jsxs)(`dl`,{className:`payment-form__invoice-metrics`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`dt`,{children:`Invoice Total`}),(0,j.jsx)(`dd`,{children:w(g)})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`dt`,{children:`Already Paid`}),(0,j.jsx)(`dd`,{children:w(_)})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`dt`,{children:`Outstanding Balance`}),(0,j.jsx)(`dd`,{children:w(b)})]})]}):null]})]})]}),(0,j.jsxs)(`div`,{className:`payment-form__section`,children:[(0,j.jsx)(`div`,{className:`payment-form__section-header`,children:(0,j.jsx)(`h3`,{children:`Payment details`})}),(0,j.jsxs)(`div`,{className:`form-grid`,children:[(0,j.jsx)(se,{id:`payment-amount`,name:`amount`,label:`Amount`,value:u.amount,onChange:C,onBlur:T,error:f.amount?x.amount:``}),(0,j.jsx)(pe,{id:`payment-date`,name:`paymentDate`,label:`Payment date`,icon:null,value:u.paymentDate,onChange:C,onBlur:T,error:f.paymentDate?x.paymentDate:``}),(0,j.jsx)(O,{id:`payment-method`,name:`paymentMethod`,label:`Payment method`,value:u.paymentMethod,onChange:C,onBlur:T,options:M}),(0,j.jsx)(ce,{id:`payment-reference`,name:`referenceNumber`,label:`Reference number`,value:u.referenceNumber,maxLength:100,onChange:C,onBlur:T,error:f.referenceNumber?x.referenceNumber:``}),(0,j.jsx)(ce,{id:`payment-notes`,name:`notes`,label:`Notes`,textarea:!0,rows:3,maxLength:500,className:`field--full`,value:u.notes,onChange:C,onBlur:T,error:f.notes?x.notes:``})]})]}),(0,j.jsxs)(`dl`,{className:`payment-form__summary-panel`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`dt`,{children:`Invoice Total`}),(0,j.jsx)(`dd`,{children:w(g)})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`dt`,{children:`Already Paid`}),(0,j.jsx)(`dd`,{children:w(_)})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`dt`,{children:`Current Payment`}),(0,j.jsx)(`dd`,{children:w(ee)})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`dt`,{children:`Balance After Payment`}),(0,j.jsx)(`dd`,{children:w(te)})]})]}),(0,j.jsxs)(`div`,{className:`button-row payment-form__footer`,children:[(0,j.jsx)(`button`,{type:`submit`,className:`button button-primary`,disabled:!ie||c,children:c?`Posting...`:`Post Payment`}),(0,j.jsx)(`button`,{type:`button`,className:`button button-cancel`,onClick:s,disabled:c,children:`Cancel`})]})]})}function at({suppliers:e,fetchPayments:t,createPayment:n,updatePayment:o,deletePayment:c}){let l=`Supplier Payments`,u=`supplierPayments`,h=`Supplier`,v=e,{hasPermission:y,user:b}=ie(),ne=re(),x=xe,T=Ce.supplier,[E,D]=(0,A.useState)([]),[se,ce]=(0,A.useState)([]),[O,ue]=(0,A.useState)(!0),[de,k]=(0,A.useState)(!1),[pe,me]=(0,A.useState)(``),[he,M]=(0,A.useState)(!1),[P,be]=(0,A.useState)(null),[F,I]=(0,A.useState)(null),[L,Ee]=(0,A.useState)(null),[H,Ae]=(0,A.useState)(`all`),[W,G]=(0,A.useState)([]),[q,Le]=(0,A.useState)(()=>tt(T)??x),[Re,Be]=(0,A.useState)(!1),Ve=(0,A.useRef)(null),He=(0,A.useRef)(null),Ue=y(u,`create`),Ke=!!o&&(y(u,`edit`)||y(u,`create`)),qe=y(u,`delete`),Xe=(0,A.useMemo)(()=>new Map(se.map(e=>[String(e.poId||e.id),e])),[se]),Ze=(0,A.useMemo)(()=>new Map,[]),J=(0,A.useCallback)(async({updateLoading:e=!0,isMounted:n=()=>!0}={})=>{e&&ue(!0),me(``);try{let[e,r]=await Promise.all([t(),fe()]);if(!n())return;if(!e.success){me(Ge(e.error||e.message)),D([]);return}D((e.data??[]).map(De)),r.success?ce(r.data??[]):me(Ge(r.error||`Unable to load purchase orders.`))}catch(e){n()&&(D([]),me(Ge(e instanceof Error?e.message:`Unable to load payment data right now.`)))}finally{n()&&ue(!1)}},[t]);(0,A.useEffect)(()=>{let e=!0;return J({isMounted:()=>e}),()=>{e=!1}},[J]),(0,A.useEffect)(()=>{Le(tt(T)??x)},[x,T]),(0,A.useEffect)(()=>{try{typeof window<`u`&&window.localStorage.setItem(T,JSON.stringify(q))}catch{}},[T,q]),(0,A.useEffect)(()=>{let e=new Set(E.map(z));G(t=>t.filter(t=>e.has(t)))},[E]),(0,A.useEffect)(()=>{function e(e){Ve.current?.contains(e.target)||Be(!1)}return document.addEventListener(`pointerdown`,e),()=>document.removeEventListener(`pointerdown`,e)},[]);let Y=(0,A.useMemo)(()=>E.filter(e=>{let t=B(e);return!(H===`success`&&t!==`Completed`||H===`pending`&&t!==`Pending`||H===`failed`&&t!==`Failed`||H===`cancelled`&&t!==`Cancelled`||H===`reversed`&&t!==`Reversed`||H===`month`&&!je(e.paymentDate,`month`)||H===`last30`&&!je(e.paymentDate,`last30`)||H===`large`&&Number(e.amount||0)<_e)}),[H,E]),X=(0,A.useMemo)(()=>E.filter(e=>W.includes(z(e))),[E,W]);(0,A.useMemo)(()=>Y.filter(e=>W.includes(z(e))),[Y,W]);let Z=(0,A.useMemo)(()=>{let e=Y.reduce((e,t)=>e+Number(t.amount||0),0),t=new Date().toISOString().slice(0,7);return{count:Y.length,totalAmount:e,thisMonth:Y.filter(e=>String(e.paymentDate).startsWith(t)).length,reconciled:Y.filter(e=>B(e)===`Completed`).length,pending:Y.filter(e=>B(e)===`Pending`).length}},[Y]);(0,A.useCallback)(e=>{let t=String(e);G(e=>{let n=e.includes(t)?e.filter(e=>e!==t):[...e,t];return E.find(e=>z(e)===t)?.paymentNumber,n.map(e=>E.find(t=>z(t)===e)?.paymentNumber||e),n})},[E]),(0,A.useCallback)(()=>{let e=Y.map(z);G(t=>e.length>0&&e.every(e=>t.includes(e))?t.filter(t=>!e.includes(t)):Array.from(new Set([...t,...e])))},[Y]);let $e=(0,A.useCallback)((e=Y)=>{let t=e.length>0?e:Y;if(t.length===0){m({type:`warning`,title:l,message:`No payments available to export.`});return}ze(t,!0,b),m({type:`success`,title:l,message:`${t.length} payment${t.length===1?``:`s`} exported as PDF.`})},[Y,l,b]),et=(0,A.useCallback)(async e=>{try{await We({payment:e,purchaseOrder:Xe.get(String(e.poId)),allPayments:E,generatedBy:b?.email||b?.name||`System`}),m({type:`success`,title:l,message:`Receipt PDF downloaded.`})}catch(e){m({type:`error`,title:l,message:e instanceof Error?e.message:`Unable to generate receipt PDF.`})}},[E,Xe,l,b]);function Q(e=X){let t=e.length>0?e:Y.slice(0,1);if(t.length===0){m({type:`warning`,title:l,message:`Select a payment to print.`});return}let n=t.map(e=>{let t=Xe.get(String(e.poId)),n=Qe(e,t,E),r=Number(n.outstandingAfter||0),i=Ye(t?.status||e.poStatus),a=V(e.status).label,o=Pe();return`
      ...
      `}).join(``),r=window.open(``,`_blank`,`width=800,height=850`);if(!r){m({type:`error`,title:l,message:`Unable to open print window.`});return}try{r.opener=null}catch{}let i=!1,a=()=>{i||r.closed||(i=!0,window.setTimeout(()=>{r.closed||(r.focus(),r.print())},150))};r.addEventListener(`load`,a,{once:!0}),r.document.open(),r.document.write(`<!doctype html><html><head><title>Supplier Payment Receipt - IMS</title><style>
    ...
    </style></head><body>${n}</body></html>`),r.document.close(),r.document.readyState===`complete`&&a()}async function at(){if(X.length!==0){k(!0);try{await Promise.all(X.map(e=>c(e.id))),await J({updateLoading:!1}),G([]),m({type:`success`,title:l,message:`Selected payments deleted.`})}catch(e){m({type:`error`,title:l,message:e instanceof Error?e.message:`Unable to delete selected payments.`})}finally{k(!1)}}}async function ot(e){k(!0);try{let t=await n({supplierId:Te(e.partyId,`Supplier`),poId:Te(e.poId,`Purchase order`),amount:Number(e.amount),paymentDate:e.paymentDate,paymentMethod:e.paymentMethod,referenceNumber:e.referenceNumber.trim(),notes:e.notes.trim()});if(!t.success)throw Error(t.error||`Unable to post payment.`);await J(),m({type:`success`,title:l,message:`Payment posted successfully.`}),M(!1)}catch(e){m({type:`error`,title:l,message:e instanceof Error?e.message:`Unable to post payment.`})}finally{k(!1)}}async function st(e,t){if(o){k(!0);try{let n=await o(e.id,{amount:Number(t.amount),paymentMethod:t.paymentMethod,referenceNumber:t.referenceNumber.trim(),notes:t.notes.trim(),status:`Completed`});if(!n.success)throw Error(n.error||`Unable to update payment.`);await J(),I(null),m({type:`success`,title:l,message:`Payment updated successfully.`})}catch(e){m({type:`error`,title:l,message:e instanceof Error?e.message:`Unable to update payment.`})}finally{k(!1)}}}async function ct(){if(!L)return;let e=E;D(e=>e.map(e=>String(e.id)===String(L.id)?{...e,status:`Cancelled`}:e)),Ee(null);let t=await c(L.id);if(!t.success){D(e),m({type:`error`,title:l,message:t.error||`Unable to delete payment.`});return}await J({updateLoading:!1}),m({type:`success`,title:l,message:`Payment deleted successfully.`})}function lt(e){Se.includes(e)||Le(t=>{let n=xe,r=t.length>0?t:n,i=r.includes(e)?r.filter(t=>t!==e):[...r,e];return Se.reduce((e,t)=>e.includes(t)?e:[...e,t],i)})}function ut(){Le(xe)}let dt=(0,A.useMemo)(()=>[{key:`paymentNumber`,label:`Payment No`,className:`payments-col-number`,mobilePrimary:!0,sortable:!0,sortValue:e=>R(e),render:e=>(0,j.jsx)(`strong`,{className:`payments-page__record-number payments-readable-cell`,title:R(e),children:R(e)}),searchValue:e=>`${R(e)} ${e.partyName} ${e.invoiceNumber} ${e.invoiceStatus} ${e.referenceNumber} ${e.status}`},{key:`paymentDate`,label:`Payment Date`,className:`payments-col-date`,sortable:!0,sortValue:e=>e.paymentDate,render:e=>{let t=g(e.paymentDate);return(0,j.jsx)(`span`,{className:`payments-readable-cell`,title:t,children:t})}},{key:`partyName`,label:h,className:`payments-col-party`,sortable:!0,render:e=>{if(e.partyName&&e.partyName!==`-`)return e.partyName;let t=e.supplierId||e.customerId||e.partyId;if(t&&Array.isArray(v)){let e=v.find(e=>String(e.id)===String(t)||String(e.supplierId)===String(t)||String(e.customerId)===String(t));if(e)return e.name||e.companyName||e.company||e.supplierName||e.customerName||`-`}return e.partyName||`-`}},{key:`amount`,label:`Amount`,className:`is-numeric payments-col-amount`,sortable:!0,sortValue:e=>Number(e.amount||0),render:e=>w(e.amount)},{key:`paymentMethod`,label:`Method`,className:`payments-col-method`,sortable:!0},{key:`referenceNumber`,label:`Reference Number`,className:`payments-col-reference`,sortable:!0,render:e=>e.referenceNumber||`Not provided`},{key:`status`,label:`Status`,className:`payments-col-status`,mobileStatus:!0,sortable:!0,sortValue:e=>B(e),render:e=>(0,j.jsx)(`div`,{className:`payments-status-menu`,"data-row-click-ignore":`true`,children:(0,j.jsx)(Oe,{status:B(e)})})},{key:`createdBy`,label:`Created By`,className:`payments-col-created-by`,sortable:!0,render:e=>e.createdBy||`System`},{key:`notes`,label:`Notes`,className:`payments-col-notes`,sortable:!0,render:e=>e.notes||`No notes`},{key:`cancelledAt`,label:`Cancelled At`,className:`payments-col-cancelled-at`,sortable:!0,render:e=>e.cancelledAt?g(e.cancelledAt):`Not cancelled`},{key:`cancellationReason`,label:`Cancellation Reason`,className:`payments-col-cancellation-reason`,sortable:!0,render:e=>e.cancellationReason||`Not provided`},{key:`actions`,label:`Actions`,className:`payments-col-actions`,searchable:!1,render:e=>(0,j.jsx)(r,{iconOnly:!0,label:`Actions for ${R(e)}`,actions:[{key:`view`,label:`View`,icon:te,onClick:()=>be(e)},Ke?{key:`edit`,label:`Edit`,icon:d,onClick:()=>I(e)}:null,{key:`download`,label:`Download receipt`,icon:s,onClick:()=>et(e)}]})}],[Ke,Y,et,Ze,!0,h]),$=(0,A.useMemo)(()=>{let e=new Set(dt.map(e=>e.key)),t=xe,n=q.filter(t=>e.has(t)),r=n.length>0?n:t.filter(t=>e.has(t));return Se.forEach(t=>{e.has(t)&&!r.includes(t)&&r.push(t)}),dt.filter(e=>r.includes(e.key))},[dt,!0,q]),ft=xe,pt=(0,A.useMemo)(()=>new Set(ft),[ft]),mt=$.some(e=>!pt.has(e.key)),ht=$.map(e=>e.key).join(`|`),gt=$.length,_t=(0,A.useMemo)(()=>$.map(e=>{let t=we[e.key];if(!t)return e;let n={width:`${t}px`,minWidth:`${t}px`,maxWidth:`${t}px`};return{...e,tableWidth:t,style:{...e.style||{},...n},headerStyle:{...e.headerStyle||e.style||{},...n}}}),[!0,$]),vt=[`card`,`payments-page__table-card`,`payments-page__table-card--supplier`,mt?`payments-page__table-card--expanded-columns`:``,`payments-page__table-card--overflow-columns`,`payments-page__table-card--${gt}-columns`].filter(Boolean).join(` `),yt=dt.filter(e=>!Se.includes(e.key)&&typeof e.label==`string`),bt=W.length>0?(0,j.jsxs)(i,{className:`payments-page__selected-actions`,ariaLabel:`Selected payment actions`,children:[(0,j.jsxs)(`div`,{className:`payments-selection-summary`,"aria-live":`polite`,"data-selection-mode":`true`,children:[(0,j.jsx)(S,{size:15}),(0,j.jsxs)(`strong`,{children:[W.length,` selected`]})]}),(0,j.jsxs)(`button`,{type:`button`,className:`button button-secondary payments-toolbar-button`,onClick:()=>$e(X),children:[(0,j.jsx)(s,{size:15}),`Export`]}),(0,j.jsxs)(`button`,{type:`button`,className:`button button-secondary payments-toolbar-button`,onClick:()=>Q(X),children:[(0,j.jsx)(f,{size:15}),`Print`]}),qe?(0,j.jsxs)(`button`,{type:`button`,className:`button button-secondary payments-toolbar-button payments-toolbar-button--danger`,onClick:at,disabled:de,children:[(0,j.jsx)(p,{size:15}),`Delete`]}):null]}):null,xt=(0,j.jsxs)(i,{className:`payments-page__toolbar-actions`,ariaLabel:`${l} table actions`,children:[(0,j.jsx)(`label`,{className:`payments-toolbar-select`,children:(0,j.jsx)(`select`,{value:H,onChange:e=>Ae(e.target.value),children:ge.map(e=>(0,j.jsx)(`option`,{value:e.value,children:e.label},e.value))})}),W.length===0?(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:`payments-column-filter`,ref:Ve,children:[(0,j.jsxs)(`button`,{ref:He,type:`button`,className:`button button-secondary payments-column-filter__trigger`,"aria-haspopup":`menu`,"aria-expanded":Re,onClick:()=>Be(e=>!e),children:[(0,j.jsx)(_,{size:15}),`Columns`]}),Re?(0,j.jsxs)(oe,{anchorRef:He,className:`payments-column-filter__menu payments-column-filter__menu--portal`,width:230,children:[(0,j.jsxs)(`div`,{className:`payments-column-filter__menu-header`,children:[(0,j.jsx)(`strong`,{children:`Visible columns`}),(0,j.jsx)(`button`,{type:`button`,onClick:ut,children:`Reset`})]}),(0,j.jsx)(`div`,{className:`payments-column-filter__options`,children:yt.map(e=>{let t=$.some(t=>t.key===e.key);return(0,j.jsxs)(`label`,{className:`payments-column-filter__option`,children:[(0,j.jsx)(`input`,{type:`checkbox`,checked:t,onChange:()=>lt(e.key)}),(0,j.jsx)(`span`,{className:`payments-column-filter__check`,"aria-hidden":`true`,children:t?(0,j.jsx)(S,{size:13}):null}),(0,j.jsx)(`span`,{children:e.label})]},e.key)})})]}):null]}),(0,j.jsxs)(`button`,{type:`button`,className:`button button-secondary payments-toolbar-button`,onClick:()=>$e(Y),disabled:Y.length===0,children:[(0,j.jsx)(s,{size:15}),`Export`]})]}):null]}),St=!!pe&&!O;return Z.count,Z.reconciled,Z.pending,ke(Z.totalAmount),(0,j.jsxs)(`div`,{className:`page payments-page payments-page--supplier`,children:[(0,j.jsxs)(`header`,{className:`resource-center__inventory-header`,"aria-label":`Supplier Payments summary`,children:[(0,j.jsxs)(`div`,{className:`resource-center__inventory-header-main`,children:[(0,j.jsx)(`h1`,{children:`Supplier Payments`}),(0,j.jsxs)(`div`,{className:`resource-center__inventory-metrics`,children:[(0,j.jsxs)(`span`,{className:`resource-center__inventory-metric resource-center__inventory-metric--success`,children:[(0,j.jsx)(`strong`,{children:Z.count}),` Payments`]}),(0,j.jsxs)(`span`,{className:`resource-center__inventory-metric resource-center__inventory-metric--success`,children:[(0,j.jsx)(`strong`,{children:Z.reconciled}),` Success`]}),(0,j.jsxs)(`span`,{className:`resource-center__inventory-metric resource-center__inventory-metric--warning`,children:[(0,j.jsx)(`strong`,{children:Z.pending}),` Pending`]}),(0,j.jsxs)(`span`,{className:`resource-center__inventory-metric resource-center__inventory-metric--info`,children:[(0,j.jsx)(`strong`,{children:ke(Z.totalAmount)}),` Collected`]})]})]}),(0,j.jsx)(`div`,{className:`resource-center__inventory-header-actions`,children:Ue?(0,j.jsxs)(`button`,{type:`button`,className:`button button-primary`,onClick:()=>M(!0),children:[(0,j.jsx)(ee,{size:16}),`New Payment`]}):null})]}),St?(0,j.jsx)(`div`,{className:`card payments-page__state-card`,children:(0,j.jsx)(ae,{type:`server`,title:`Unable to load payment data`,message:`${pe} Please try again in a few moments.`,actionLabel:`Retry`,onAction:()=>J(),compact:!0})}):(0,j.jsx)(`div`,{className:`${vt} resource-center__inventory-table-card`,children:(0,j.jsx)(a,{className:`resource-center__inventory-table`,rows:Y,columns:_t,keyField:`paymentRowId`,loading:O,defaultPageSize:20,allowSortReset:!0,showSearch:W.length===0,searchKeys:[`paymentNumber`,`partyName`,`referenceNumber`],searchPlaceholder:`Search payments`,emptyMessage:`No supplier payments available.`,hideSelectionSummary:!0,filterContent:bt,toolbarContent:xt,rowClassName:e=>W.includes(z(e))?`is-selected`:``,showColumnControls:!1,enableRowSelection:!0,selectedRowKeys:W,onSelectionChange:G,fitExplicitColumnsToContainer:!1,showHorizontalScrollbar:mt,splitToolbar:!0},ht)}),he?(0,j.jsx)(le,{title:`Post ${h} Payment`,onClose:()=>M(!1),children:(0,j.jsx)(it,{type:`supplier`,partyLabel:h,parties:v,invoices:[],purchaseOrders:se,existingPayments:E,onSubmit:ot,onCancel:()=>M(!1),isSubmitting:de})}):null,P?(0,j.jsx)(nt,{payment:P,purchaseOrder:Xe.get(String(P.poId)),allPayments:E,onClose:()=>be(null),onPrint:Q,onDownloadReceipt:et,onOpenPurchaseOrder:e=>{let t=e?.poId;ne(t?`/inventory/purchases/${t}`:`/inventory/purchases`)}}):null,F?(0,j.jsx)(rt,{payment:F,invoice:Ze.get(String(F.invoiceId)),onSubmit:st,onClose:()=>I(null),isSubmitting:de}):null,L?(0,j.jsx)(le,{title:L.deleteMode===`void`?`Void Payment`:`Delete Payment`,onClose:()=>Ee(null),children:(0,j.jsxs)(`div`,{className:`payment-delete-dialog`,children:[(0,j.jsx)(`div`,{className:`payment-delete-dialog__icon`,children:(0,j.jsx)(C,{size:18})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`h3`,{children:L.deleteMode===`void`?`Void this payment?`:`Delete this payment?`}),(0,j.jsxs)(`p`,{children:[`Payment `,(0,j.jsx)(`strong`,{children:R(L)}),` for `,(0,j.jsx)(`strong`,{children:L.partyName}),` worth`,` `,(0,j.jsx)(`strong`,{children:w(L.amount)}),` will be cancelled and the ledger balances will be reversed.`]})]}),(0,j.jsxs)(`div`,{className:`button-row payment-delete-dialog__actions`,children:[(0,j.jsx)(`button`,{type:`button`,className:`button button-secondary button-cancel`,onClick:()=>Ee(null),children:`Cancel`}),(0,j.jsx)(`button`,{type:`button`,className:`button button-danger`,onClick:ct,children:L.deleteMode===`void`?`Void Payment`:`Delete Payment`})]})]})}):null]})}function ot({suppliers:e}){let[t,n]=(0,A.useState)(e||[]);return(0,A.useEffect)(()=>{D().then(e=>{e?.success&&Array.isArray(e?.data)&&e.data.length>0&&n(e.data)}).catch(()=>{})},[]),(0,j.jsx)(at,{suppliers:t?.length?t:e,fetchPayments:ue,createPayment:k,deletePayment:de})}export{ot as default};